...
**Status:** početni nacrt prije implementacije
...
Trenutačna naredba `python -m aetherfront` samo provjerava razvojne ovisnosti. Nakon implementacije ista će naredba pokretati igru. Ruff i Pytest već su konfigurirani, a PyInstaller će se koristiti za kasniju izradu `.app` aplikacije i ZIP-a.
